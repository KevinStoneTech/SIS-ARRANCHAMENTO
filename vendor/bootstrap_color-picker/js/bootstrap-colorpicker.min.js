        ...
        stringToHSB: function (b) {
            ...
            return a.each(this.stringParsers, function (a, f) {
                var g = f.re.exec(b),
                    ...
                    i = c || f.format || "rgba";
                return !h || (e = i.match(/hsla?/) ? d.RGBtoHSB.apply(d, d.HSLtoRGB.apply(d, h)) : d.RGBtoHSB.apply(d, h), d.origFormat = i, !1)
            }), e
        },
        setHue: function (a) {
            this.value.h = 1 - a
