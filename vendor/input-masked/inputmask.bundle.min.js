...
function (a) {
    ...
    function g(c, d) {
        function e(b) {
            ...
            for (var j, k, l, m, n, o, p, q = /(?:[?*+]|\{[0-9\+\*]+(?:,[0-9\+\*]*)?\})|[^.?*+^${[]()|\\]+|./g, r = !1, s = new d, t = [], u = []; j = q.exec(b);) if (k = j[0], r) h();
        ...
        function v(b, c, d) {
            ...
            function f(b) {
                ...
                return a.isArray(b) || (b = [b]), b.length > 0 && (void 0 === b[0].alternation ? (c = q(b.slice()).locator.slice(), 0 === c.length && (c = b[0].locator.slice())) : a.each(b, function (a, b) {
                    ...
                    else for (var d = 0; d < c.length; d++) b.locator[d] && c[d].toString().indexOf(b.locator[d]) === -1 && (c[d] += "," + b.locator[d])
                })), c
            }
            function h(a) {
