...
$_SESSION['sistema2'] = base64_decode($sistema);
    ...
    <body>
        <div class="wrap">
            <div class="container">
                <div class="logo">                    
                    <div class="avatar">
                        <img alt="Sistema de Arranchamento" src="favicon/geleia.png" />
                    </div>
                </div>                
                    ...
                    <div class="panel">
                        <div class="panel-content bg-scale-0">
                            <div class="text-center">
                                <h3>SISTEMA DE ARRANCHAMENTO</h3>
                            </div>
                            <?php
                            if ($token <> "") {
                                ?>
                            ...
                            <form id="inline-validation" action="chkpass.php" method="post">
                                ...
                                <div class="form-group text-center">                                   
                                    <span>Sistema desenvolvido pelo 2º Sgt Francês (unsolity@hotmail.com)</span></br>                                  
